...
#******
##Linear mixed effects models for 2020 (Shannon Diversity) -- no documented effects

##to calculate Shannon Diversity
diversity2020 <- as.data.frame(cbind(year2020[1:4],diversity(index = "inv", year2020[5:11])))
...
#******
##Linear mixed effects models for 2020 to test for abundance
...
##to calculate Shannon Diversity
diversity2021 <- as.data.frame(cbind(year2021[1:4],diversity(index = "inv", year2021[5:11])))
...
#relative pathname
pit <- file.path(".", "Data", "Pitfall_data_all.csv")
print(pit)
